...
class AddOrderService extends StatefulWidget {
  var data;
  AddOrderService(this.data);
  @override
  State<StatefulWidget> createState() => AddOrderServiceState();
}

class AddOrderServiceState extends State<AddOrderService> {
              ...
              children: [
                Column(
                  children: [
                    ...
                    (widget.data["price"] == 0 || widget.data["price"] == null)
                        ? Directionality(
                            textDirection: TextDirection.rtl,
                            child: TextFormField(
                              validator: validateForm,
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () async {
                        if (formKey.currentState.validate()) {
                          ...
                          result = await OrdersService.add(
                              data: widget.data,
